...
@app.route('/signupleader', methods=['POST', 'GET'])
def signupleader():
    if request.method == 'POST':
        ...
        if users.find_one({"email": email}):
            ...
            return redirect(url_for('signupleader'))
    ...
    return render_template('signupleader.html')
...
def create_group():
    if request.method == 'POST':
        ...
        elif user['account'] == 'basic':
            print("a") # CODE FOR ACCEPTING PAYMENTS
